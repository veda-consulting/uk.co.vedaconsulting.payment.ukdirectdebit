...
class CRM_Contribute_Form_UpdateSubscription extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->add('text', 'account_holder', ts('Account Holder'), array('size' => 20, 'maxlength' => 18, 'autocomplete' => 'on'), TRUE);
    $this->add('text', 'bank_account_number', ts('Bank Account Number'), array('size' => 20, 'maxlength' => 8, 'autocomplete' => 'off'), TRUE);
    $this->add('text', 'bank_identification_number', ts('Sort Code'), array('size' => 20, 'maxlength' => 6, 'autocomplete' => 'off'), TRUE);
    $this->add('text', 'bank_name', ts('Bank Name'), array('size' => 20, 'maxlength' => 64, 'autocomplete' => 'off'), TRUE);
