...
<div class="crm-block crm-form-block crm-recurcontrib-form-block">
  ...
  <table class="form-layout">
    ...
    <tr>
      <td class="label">{$form.bank_account_number.label}</td><td>{$form.bank_account_number.html}<br /> 
    </tr>
    <tr>
      <td class="label">{$form.bank_identification_number.label}</td><td>{$form.bank_identification_number.html}<br /> 
    </tr>
    <tr>
      <td class="label">{$form.bank_name.label}</td><td>{$form.bank_name.html}<br /> 
    </tr>
    {/if}
    {if !$self_service}
