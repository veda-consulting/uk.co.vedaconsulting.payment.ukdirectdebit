...
CRM_Core_Error::debug_log_message('CRM_Contribute_Form_Contribution_Confirm #1');
        ...
        CRM_Core_Error::debug( 'Firing IPN code');
...
CRM_Core_Error::debug_log_message('uk_direct_debit_civicrm_postProcess #2');
            ...
            CRM_Core_Error::debug( 'paymentProcessorType', $paymentProcessorType);
            CRM_Core_Error::debug( 'paymentType', $paymentType);
            CRM_Core_Error::debug( 'membershipID', $membershipID);
            CRM_Core_Error::debug( 'contributionID', $contributionID);
            CRM_Core_Error::debug( 'contactID', $contactID);
            CRM_Core_Error::debug( 'invoiceID', $invoiceID);
            CRM_Core_Error::debug( 'amount', $amount);
            CRM_Core_Error::debug( 'isRecur', $isRecur);
//CRM_Core_Error::debug( 'CIVICRM_UF_BASEURL', CIVICRM_UF_BASEURL);

            // Get the recur ID for the contribution
            $url = CRM_Utils_System::url(
                        'civicrm/payment/ipn', // $path
                        "processor_name=".$paymentProcessorType."&module=contribute&contactID=".$contactID."&contributionID=".$contributionID."&membershipID=".$membershipID."&invoice=".$invoiceID."&mc_gross=".$amount."&payment_status=Completed&txn_type=recurring_payment", // $query
                        FALSE, // $absolute
                        NULL, // $fragment
                        FALSE, // $htmlize
                        FALSE, // $frontend
...
CRM_Core_Error::debug_log_message('call_CiviCRM_IPN url='.$url);
  ...
  CRM_Core_Error::debug( 'reult : ', $output);
